...
func renderMetrics(sn *statsSnapshot) []byte {
	...
	writeMetric(&b, "flokbn_uptime_seconds", "gauge",
	...
	writeMetric(&b, "flokbn_ban_active", "gauge",
	...
	writeMetric(&b, "flokbn_ua_list_active_ips", "gauge",
	...
	writeMetric(&b, "flokbn_loop_iterations_total", "counter",
		"Live loop iterations since startup.",
		sample{value: float64(sn.Loop.Iterations)})
	writeMetric(&b, "flokbn_loop_heartbeats_total", "counter",
